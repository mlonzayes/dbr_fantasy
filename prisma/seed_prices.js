...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var players, _i, players_1, player, ranPrice;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    player = players_1[_i];
                    ranPrice = Math.floor(Math.random() * 150) + 1;
                ...
                case 5:
                    ...
                    return [3 /*break*/, 3];
                case 6:
                    console.log("Updated ".concat(players.length, " players with random starting prices between 1 and 150."));
                    return [2 /*return*/];
            }
        });
    });
